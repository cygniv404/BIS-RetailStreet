...
(function () {
    ...
    $(document).ready(function () {
        ...
        /* ---------------------------------------------
         toggle searchfieldInfo
         --------------------------------------------- */

           var allToggles = $(".toggle > dd").hide();

           $(".icon-searchfield-viewmore").click(function () {

                   $(this).parent().find(".info-searchfield").toggleClass("active");
                   $(this).parent().find(".icon1").toggleClass("active");
                   $(this).parent().find(".icon2").toggleClass("active2");
